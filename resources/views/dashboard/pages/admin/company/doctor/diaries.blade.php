            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="#" class="btn btn-effect-ripple btn-warning" data-dismiss="modal" id="eventDelete">Cancelar cita</a>
                        <a href="#" class="btn btn-effect-ripple btn-success" data-dismiss="modal" id="EventActivate">Activar Paciente</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form id="clickable-wizard" action="page_forms_wizard.php" method="post" class="form-horizontal form-bordered">
                        <div class="modal-body">
                            ...
                            <div id="clickable-third" class="step">
                               ...
                               {!! Field::selectSimple('eps', $diaryTypes, null, ['data-placeholder' => 'Seleccione una eps', 'template' => 'horizontalmodal', 'id' => 'eps']) !!}
                               {!! Field::selectSimple('membershipTypes', $diaryTypes, null, ['data-placeholder' => 'Seleccione tipo de afiliación', 'template' => 'horizontalmodal', 'id' => 'membershipTypes']) !!}
                            </div>
                            <!-- END Third Step -->
                        </div>
                    </form>
