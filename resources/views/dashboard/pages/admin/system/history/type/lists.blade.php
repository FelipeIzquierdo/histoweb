@extends('dashboard.pages.layout')
	...
	@section('dashboard_title')
		<h1>
			...
			Tipos de antecedentes
			<a href="{{ route('admin.system.history-types.create') }}" class="btn btn-info" title="Nuevo tipo de antecedente">
	...
	@section('breadcrumbs')
		{!! Breadcrumbs::render('history_type') !!}
	@endsection

	@section('dashboard_body')
			<div class="block">
			<div class="block-title clearfix">
				<h2><span class="hidden-xs">Lista de</span> Tipos de antecedentes</h2>
			</div>
