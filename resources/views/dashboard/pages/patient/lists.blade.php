@extends('dashboard.pages.layout')
	...
	@section('dashboard_title')
		<h1>
			...
			Pacientes
			<a href="{{ route('patients.create') }}" class="btn btn-info" title="Nuevo Paciente">
						...
						@foreach($patients as $patient)
							<tr>
								...
								<td class="text-center">
									<a href="{{ route('patients.edit', $patient->id) }}" data-toggle="tooltip" title="" class="btn btn-effect-ripple btn-sm btn-warning" data-original-title="Editar Paciente"><i class="fa fa-pencil"></i></a>
								</td>
							</tr>
						@endforeach
					</tbody>
