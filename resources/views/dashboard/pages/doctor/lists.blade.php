			...
			<div class="col-sm-4">
				<div class="widget">
					<div class="widget-content text-right clearfix themed-background-flat">
						<a href="{{ route('doctors.edit', $doctor->id) }}" class="pull-left">
					...
					<div class="widget-content themed-background-muted text-center">
						<div class="btn-group">
							<a href="{{ route('doctors.availabilities.index', $doctor->id) }}" title="Dispoinibilidad" class="btn btn-effect-ripple btn-warning"><i class="fa fa-calendar"></i></a>
							<a href="{{ route('doctors.schedules.index', $doctor->id) }}" title="Horario" class="btn btn-effect-ripple btn-success"><i class="fa fa-suitcase"></i></a>
							<a href="{{ route('doctors.diaries.index', $doctor->id) }}" title="Citas" class="btn btn-effect-ripple btn-info"><i class="fa fa-phone"></i></a>
						</div>
					</div>
				</div>
			</div>
